...
// components
import { PokedexView, Card, FlexBox, Button, Loading, Header } from "../../components/components";
import { atomHashPokemon } from "../../store/hashs/hash";

// types
import type { ISinglePokemon } from "./singlePokemon.types";
